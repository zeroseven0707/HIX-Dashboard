                                        ...
                                        <div class="col col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select id="kecamatan" name="kecamatanId" class="form-control">
                                                    ...
                                                    <option value="2" data-lat="-7.366067003699387"
                                                        data-long="108.09983979340981">
                                                        Mangunreja
                                                    </option>
                                                    <option value="2" data-lat="-7.346629297090453"
                                                        data-long="108.21421542188415">
                                                        Tasik
                                                    </option>
                                                    <option value="2" data-lat="-7.517400630339682"
                                                        data-long="108.16668792641741">
                                                        Cibalong
                                                    </option>
                                                    <option value="2" data-lat="-7.3503831023015"
