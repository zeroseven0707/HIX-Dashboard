    ...
    <div class="page-content">
        <div class="container mt-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-primary">Detail Shipping On Delivery</h2>
                <button wire:click="back" class="btn btn-primary mt-3">Back</button>
            </div>
            ...
            @if(!empty($details))
                @if (!empty($details['kecamatan']))
                    <div class="card mb-4 shadow">
                        <div class="card-body">
                            <h4 class="card-title text-info">Kecamatan: {{ $details['kecamatan'] }}</h4>
                        </div>
                    </div>
                @endif
