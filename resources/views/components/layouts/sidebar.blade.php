<aside class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
      ...
      <li class="menu-label">Regular</li>
      {{-- <li>
        <a href="/shipping-new">
          <div class="parent-icon">
      ...
      <li>
        <a href="/shipping-on">
          ...
          <i class="ms-auto" id="data-count">0</i>
        </a>
      </li>
      <li>
      ...
      <li>
        ...
        <ul>
          ...
          <li> <a href="/finance-merchant">
            <ion-icon name="ellipse-outline"></ion-icon>Merchant
          </a>
        </li>
          <li> <a href="/deposit">
              <ion-icon name="ellipse-outline"></ion-icon>Deposit
            </a>
          </li>
